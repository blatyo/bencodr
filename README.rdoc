...
== Installation
    ...
    Successfully installed bencode_blatyo-1.0.1
    1 gem installed
    Installing ri documentation for bencode_blatyo-1.0.1...
    Building YARD (yri) index for bencode_blatyo-1.0.1...
    Installing RDoc documentation for bencode_blatyo-1.0.1.
